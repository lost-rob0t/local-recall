...
class FakeRetrieval:
    ...
    async def retrieve(self, query: object) -> RetrievalBatch:
...
def make_service(retrieval: FakeRetrieval, provider: FakeLocalProvider) -> object:
    return service_module.AnsweringService(
        retrieval=retrieval,
